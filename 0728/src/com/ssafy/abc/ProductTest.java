...
public class ProductTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("----------------------- TV 상품검색 : 50인치 이상----------------------");
		for (Tv b : pm.searchByTv50inch()) {
			System.out.println(b);
		}
		System.out.println();
		
		System.out.println("--------------------- 냉장고 상품검색 : 400L 이상 --------------------");
		for (Refrigerator b : pm.searchByRefrigerator400L()) {
			System.out.println(b);
		}
		System.out.println();
		
		System.out.println("--------------------상품명 검색 : --------------------");
		System.out.print("상품 번호와 가격을 입력해주세요");
		int num = sc.nextInt();
		pm.changePrice(num, sc.nextInt());
		System.out.println(pm.list(num));
